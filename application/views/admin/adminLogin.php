...
<body class="hold-transition theme-primary bg-img" style="background-image: url(<?= ADMIN_ASSET_PATH;?>images/auth-bg/bg-16.jpg)" align="center">
	<br><br><center>
				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-10">
								...
								<form action="<?=base_url();?>admin/login" method="post">
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" name="email"class="form-control ps-30 bg-transparent" placeholder="Username">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="text-fade ti-lock"></i></span>
											<input type="password"name="password" class="form-control ps-30 bg-transparent" placeholder="Password">
										</div>
									</div>
									  <div class="row">
										<div class="col-6">
										...
										<div class="col-6">
										 <div class="fog-pwd text-end">
											<a href="javascript:void(0)" class="text-primary fw-600 hover-primary"><i class="ion ion-locked"></i> Forgot password?</a><br>
										  </div>
										</div>
										<!-- /.col -->
